...
export async function DELETE() {
  try {
    ...
    try {
      ...
      if (!deleted) {
        return NextResponse.json({ success: false, message: "User not found or deletion failed" }, { status: 404 })
      }
...
// PUT fonksiyonu - profil güncelleme
